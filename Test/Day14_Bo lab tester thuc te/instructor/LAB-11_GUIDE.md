# Instructor Guide — LAB-11 Luồng chọn phim → đặt vé
...
- Reset fixture: `node fixtures/reset.mjs --mode buggy --lab LAB-11`.

## Đáp án định hướng

- Controlled fault: `F-D14-011`.
- Quy tắc đúng: Ghế đã đặt không được hiển thị là có thể chọn.
- Finding demo tham chiếu: Chưa có finding xác nhận.
...
1. Chạy `node fixtures/reset.mjs --mode clean --lab LAB-11`; fault phải biến mất.
