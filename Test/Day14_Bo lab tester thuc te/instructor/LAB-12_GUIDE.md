# Instructor Guide — LAB-12 Mini Regression Suite

## Chuẩn bị

- Kiểm tra truy cập: https://demo1.cybersoft.edu.vn/
- Không phát `fixtures/manifest.json` hoặc tài liệu instructor cho học viên trước khi nộp.
- Reset fixture: `node fixtures/reset.mjs --mode buggy --lab LAB-12`.

## Đáp án định hướng

- Controlled fault: `F-D14-012`.
- Quy tắc đúng: Regression case ID phải duy nhất và ca ghi dữ liệu phải có cleanup.
- Finding demo tham chiếu: RF-001..RF-004 có thể làm dữ liệu regression API.
...
1. Chạy `node fixtures/reset.mjs --mode clean --lab LAB-12`; fault phải biến mất.
