# Instructor Guide — LAB-04 Auth API bệnh viện

## Chuẩn bị

- Kiểm tra truy cập: https://api-hospital.cybersoft.edu.vn/swagger/index.html
- Không phát `fixtures/manifest.json` hoặc tài liệu instructor cho học viên trước khi nộp.
- Reset fixture: `node fixtures/reset.mjs --mode buggy --lab LAB-04`.

## Đáp án định hướng

- Controlled fault: `F-D14-004`.
- Quy tắc đúng: API bệnh viện dùng Authorization: Bearer; không dùng TokenCybersoft.
- Finding demo tham chiếu: RF-005 (điểm dạy), RF-006 (CANDIDATE).
...
1. Chạy `node fixtures/reset.mjs --mode clean --lab LAB-04`; fault phải biến mất.
