# Instructor Guide — LAB-02 Exploratory Danh sách phim & Đặt vé
...
- Reset fixture: `node fixtures/reset.mjs --mode buggy --lab LAB-02`.

## Đáp án định hướng

- Controlled fault: `F-D14-002`.
- Quy tắc đúng: Mã phim không tồn tại phải trả trạng thái không tìm thấy, không phải lỗi server.
- Finding demo tham chiếu: RF-009 (CANDIDATE).
...
1. Chạy `node fixtures/reset.mjs --mode clean --lab LAB-02`; fault phải biến mất.
