"""Embedding Engine for CyberSoft RAG Hybrid Retrieval.

Tuần 4 - RAG và AI Tutor (Task 18)
Provides semantic dense vector representation with L2 normalization
for deterministic, low-latency, and reproducible cosine similarity search.
"""
