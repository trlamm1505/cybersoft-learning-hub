...
> *Phiên bản Registry: 1.0.0 | Cập nhật lần cuối: 2026-09-13 16:38:11Z*
...
- **Phiên bản mới nhất:** `v1.0.0` (Xuất bản: `2026-09-13T16:38:11.039922Z`)
...
- **File Manifest:** `registry_store\manifests\ds-retail-ecommerce-sales-v1_v1.0.0.json`
- **Tài nguyên đính kèm:**
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task06\data\clean\customers.csv`
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task06\data\clean\products.csv`
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task06\data\clean\orders.csv`
...
- **Phiên bản mới nhất:** `v1.1.0` (Xuất bản: `2026-09-13T16:38:11.136613Z`)
...
- **Vai trò đích:** data_analyst, bi_analyst
- **File Manifest:** `registry_store\manifests\ds-hr-operations-attendance-v1_v1.1.0.json`
- **Tài nguyên đính kèm:**
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task07\data\clean\employees.csv`
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task07\data\clean\attendance.csv`
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task07\data\clean\kpi_evaluations.csv`
...
- **Phiên bản mới nhất:** `v1.0.0` (Xuất bản: `2026-09-13T16:38:11.405399Z`)
...
- **File Manifest:** `registry_store\manifests\ds-nlp-rag-tutor-knowledgebase-v1_v1.0.0.json`
- **Tài nguyên đính kèm:**
  - `D:\Cybersoft\Kien\cybersoft-learning-hub\Data-AI-Resource\BaoCao_Task08\data\eval_qa\rag_eval_questions.json`
