"""Vector Index Engine for CyberSoft RAG Baseline.
...
class VectorIndex:
    ...
    def search(
        ...
        # Compute dot products with all indexed vectors
        scores = np.dot(self.vectors, q_flat)
    ...
    def save(
        ...
        # Compute SHA-256 checksum of generated artifact
