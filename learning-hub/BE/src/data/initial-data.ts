...
export const INITIAL_COURSES = [
  {
    ...
    description:
      'Khóa học chuyển giao từ Scratch sang Python thực chiến qua các minigame hấp dẫn.',
    thumbnail:
        ...
        exercises: [
          {
            ...
            description:
              'Cho hai số nguyên A và B. In ra kết quả tổng A + B trên một dòng.',
            type: 'CODE_TEXT',
            difficulty: 'EASY',
            points: 10,
  ...
  },
  {
    ...
    description:
      'Thực hành các câu lệnh SQL SELECT, JOIN, GROUP BY trên Dataset thương mại điện tử.',
    thumbnail:
        ...
        exercises: [
          {
            ...
            description:
              'Viết câu lệnh SQL lọc tất cả đơn hàng có `total_amount > 500`.',
            type: 'SQL_LAB',
            difficulty: 'EASY',
            points: 15,
            ...
            testCases: [
              {
                input:
                  'CREATE TABLE orders (id INT, total_amount INT); INSERT INTO orders VALUES (1, 600);',
                expectedOutput: '1|600',
                isHidden: false,
              },
              {
                input:
                  'CREATE TABLE orders (id INT, total_amount INT); INSERT INTO orders VALUES (1, 1000);',
